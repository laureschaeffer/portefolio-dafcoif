...
const couleurCreativeImg = new Proxy({"src":"/_astro/travail_11.BFlcU02H.jpg","width":1288,"height":1716,"format":"jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/laragon/www/portefolio-dafcoif/src/assets/img/travail_11.jpg";
							}
...
const coupeAlternativeImg = new Proxy({"src":"/_astro/travail_10.kJYc9dhN.jpg","width":1284,"height":1712,"format":"jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "C:/laragon/www/portefolio-dafcoif/src/assets/img/travail_10.jpg";
							}
